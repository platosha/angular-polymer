...
Additionally, although discouraged, you might want to test interactions with Polymer elements.
That requires Karma to be configured appropriately in order to import all elements used in your tests.
...
Then, testing the internals of Polymer elements should work. Note that Polymer elements are already
unit tested by their authors, and you should not test them.
